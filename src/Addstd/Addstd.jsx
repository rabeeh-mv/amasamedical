    ...
    <>
      ...
      <div className="max-w-sm mx-auto">
        ...
        <div className="mt-3 mb-5">
          ...
          {studentToEdit && <button className=" text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={resetForm}>Cancel</button>}
        </div>
      </div>
      <DisplayStd
        Addstd={Addstd}
