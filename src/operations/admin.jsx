  ...
  return (
    <div className='p-6 bg-gray-100 '>
      ...
      <div className='flex flex-wrap md:justify-between'>
          <div className=" h-20 w-full bg-white m-3 sm:m-6 border-b-2 sm:border-b-4 sm:w-1/5 sm:h-24 border-yellow-500 flex justify-around items-center"onClick={()=>list('student')}>
